    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50 flex items-center justify-between p-4">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-lrs-blue rounded-lg flex items-center justify-center">
      ...
      <nav className="hidden md:fixed md:left-0 md:top-0 md:bottom-0 md:w-64 md:bg-white md:border-r md:border-gray-200 md:flex md:flex-col">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-lrs-blue rounded-lg flex items-center justify-center">
              <Car className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="font-bold text-lrs-dark text-lg">LRS Motors</h1>
              <p className="text-xs text-gray-500 uppercase tracking-wider">Dealership</p>
            </div>
          </div>
        </div>
        ...
        {/* User Info */}
        {user && (
          <div className="px-6 py-4 border-b border-gray-200 bg-lrs-light">
                ...
                <Link key={href} href={href}>
                  <div
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors font-medium ${
                      isActive
                        ? "bg-lrs-blue text-white shadow-md"
                        : "text-gray-700 hover:bg-gray-100"
                    }`}
                  >
                    <Icon className="w-5 h-5" />
